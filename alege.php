...
if (isset($_POST['submit'])) {
    ...
    if ($resultClient->num_rows > 0) {
        ...
        echo '<h3>Informații asociate pentru:</h3>';
    ...
    echo '<form method="post" action="intermediar.php">';
    echo '   <input type="hidden" name="idClient" value="' . $idClient . '">';
    echo '   <input type="submit" name="modifica" value="Modifică">';
    echo '   <input type="submit" name="sterge" value="Șterge">';
    echo '</form>';
